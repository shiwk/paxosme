//
// Created by kk on 2023/2/8.
//

#ifndef PAXOSME_IO_CLIENT_SERVER_HPP
#define PAXOSME_IO_CLIENT_SERVER_HPP
...
//                                                       ReadValidation();
        ...
        private:
            ...
            void WriteHeader() {
                ...
                boost::asio::async_write(m_socket, boost::asio::buffer(&m_qMessagesOut.front().header,
            ...
            void WriteBody() {
                ...
                boost::asio::async_write(m_socket, boost::asio::buffer(m_qMessagesOut.front().body.data(),
...
#endif //PAXOSME_IO_CLIENT_SERVER_HPP
